...
console.log('I love my dog Caesar');
...
// use back-quotes as those are rarely used in most texts so allow for double and single quotes to be used within them without any problems (usually)
...
const message = `${parkName} has a ${dinosaurType}!`;
console.log(message);
...
const eventsMessage = `There are ${numOfEvents} upcoming events in ${city}`;
...
// -------------------------------------------------------------
// EXERCISE 6
// Boolean values can either be 'true' or 'false'. These are extermely useful for making decisions in our code.
// --------------------------------------------------------------
...
let favouritePodcasts = [`Welcome to NightVale`, `The Adventure Zone`, `My Brother, My brother and Me`];
...
let stockPrices = [2.34, 3424, 345.2342];
